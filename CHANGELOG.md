...
* **deps:** update typescript-eslint monorepo to v8.62.0

### Bug Fixes

* add support for .cjs and .mjs file extensions in resolver configuration

## [65.5.1](https://github.com/christophehurpeau/eslint-config-pob/compare/v65.5.0...v65.5.1) (2026-06-28)

### Bug Fixes

* simplify rules structure in import-x configuration
* update test script to match file patterns and remove unused test file
...
* baseModule scripts as node
* commonjs conditionNames
* **deps:** update dependency @eslint/json to ^1.2.0 ([#838](https://github.com/christophehurpeau/eslint-config-pob/issues/838))

## [65.4.1](https://github.com/christophehurpeau/eslint-config-pob/compare/v65.4.0...v65.4.1) (2026-05-01)
...
* **deps:** update dependency eslint-plugin-unicorn to v64 ([#835](https://github.com/christophehurpeau/eslint-config-pob/issues/835))
* **deps:** update typescript-eslint monorepo to v8.59.1 ([#833](https://github.com/christophehurpeau/eslint-config-pob/issues/833))

## [65.3.0](https://github.com/christophehurpeau/eslint-config-pob/compare/v65.2.0...v65.3.0) (2026-03-23)

### Features

* **deps:** update typescript-eslint monorepo to v8.57.1 ([#832](https://github.com/christophehurpeau/eslint-config-pob/issues/832))

### Bug Fixes

* dedupe typescript-eslint/types ([#829](https://github.com/christophehurpeau/eslint-config-pob/issues/829))
* **deps:** update dependency eslint-plugin-import-x to v4.16.2 ([#831](https://github.com/christophehurpeau/eslint-config-pob/issues/831))

## [65.2.0](https://github.com/christophehurpeau/eslint-config-pob/compare/v65.1.0...v65.2.0) (2026-03-01)
...
* **deps:** update dependency @eslint/json to v1 ([#821](https://github.com/christophehurpeau/eslint-config-pob/issues/821))
* **deps:** update dependency eslint-plugin-regexp to v3 ([#820](https://github.com/christophehurpeau/eslint-config-pob/issues/820))
* **deps:** update dependency eslint-plugin-unicorn to v63 ([#824](https://github.com/christophehurpeau/eslint-config-pob/issues/824))
...
* don't apply typescriptConfigs twice
* testOverrideConfigs

## [65.0.2](https://github.com/christophehurpeau/eslint-config-pob/compare/v65.0.1...v65.0.2) (2025-12-28)

### Bug Fixes

* correct typescript test files

## [65.0.1](https://github.com/christophehurpeau/eslint-config-pob/compare/v65.0.0...v65.0.1) (2025-12-28)

### Bug Fixes

* node typescript import-x resolver
...
## [64.1.3](https://github.com/christophehurpeau/eslint-config-pob/compare/v64.1.2...v64.1.3) (2025-12-07)

Note: no notable changes


## [64.1.2](https://github.com/christophehurpeau/eslint-config-pob/compare/v64.1.1...v64.1.2) (2025-12-07)

Note: no notable changes


## [64.1.1](https://github.com/christophehurpeau/eslint-config-pob/compare/v64.1.0...v64.1.1) (2025-12-07)
...
* fix typescript error ([12827b3](https://github.com/christophehurpeau/eslint-config-pob/commit/12827b3eb736d720be7d8e09a99b8adbf60ca00c))
...
* **deps:** update dependency eslint-plugin-react to v7.37.5 ([#759](https://github.com/christophehurpeau/eslint-config-pob/issues/759)) ([8559ada](https://github.com/christophehurpeau/eslint-config-pob/commit/8559ada8b427ea7ab1e27f87423bdf2891e2731d))
...
* **deps:** update typescript-eslint monorepo ([#719](https://github.com/christophehurpeau/eslint-config-pob/issues/719)) ([46cd7fc](https://github.com/christophehurpeau/eslint-config-pob/commit/46cd7fc1e995952d49f3a00f701590158dfb50a4))
...
* **deps:** update dependency eslint-plugin-react to v7.37.4 ([#728](https://github.com/christophehurpeau/eslint-config-pob/issues/728)) ([a0f4416](https://github.com/christophehurpeau/eslint-config-pob/commit/a0f4416ede803ee684f0d91f0e09aaa4261e79b1))
...
* **deps:** update dependency eslint-plugin-react-hooks to v5.1.0 ([#708](https://github.com/christophehurpeau/eslint-config-pob/issues/708)) ([3c7f93f](https://github.com/christophehurpeau/eslint-config-pob/commit/3c7f93f990117592aa4ad33d51b7656d5d1fa310))
...
* update conventional-version plugin ([08f1fa0](https://github.com/christophehurpeau/eslint-config-pob/commit/08f1fa06295d52b91376bc4b1eacb69ff72d5f18))
